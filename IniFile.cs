...
namespace AlarmSystem
{
    ...
    {
        public CustomIniFile(string aFileName) { FileName = aFileName; }
    ...
    public class IniFile : CustomIniFile
    {
        ...
        public override string ReadString(string section, string ident, string Default)
        {
            ...
            var vCount = GetPrivateProfileString(
                                                 section,
                                                 ident,
                                                 Default,
                                                 vBuffer,
        ...
        public override bool WriteString(string section, string ident, string value) => WritePrivateProfileString(section, ident, value, FileName);
        ...
        public override bool ReadSectionValues(string section, List<string> strings)
        {
            ...
            if (!ReadSection(section, vIdentList))
                return false;
            foreach (var vIdent in vIdentList)
        ...
        public override bool ReadSection(string section, List<string> strings)
        {
            ...
            var vLength = GetPrivateProfileString(
                                                  section,
                                                  null,
                                                  null,
                                                  vBuffer,
        ...
        public override bool EraseSection(string section) => WritePrivateProfileString(section, null, null, FileName);
        ...
        /// <returns>返回删除是否成功。</returns>
        public override bool DeleteKey(string section, string ident) => WritePrivateProfileString(section, ident, null, FileName);

        /// <summary>
        ///     更新文件。
        /// </summary>
        /// <returns>返回更新是否成功。</returns>
        public override bool UpdateFile() => WritePrivateProfileString(null, null, null, FileName);
    }
}
